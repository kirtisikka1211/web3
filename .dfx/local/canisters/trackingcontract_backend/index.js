...
import { idlFactory } from './trackingcontract_backend.did.js';
export { idlFactory } from './trackingcontract_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TRACKINGCONTRACT_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./trackingcontract_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the trackingcontract_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./trackingcontract_backend.did.js")._SERVICE>}
 */
export const trackingcontract_backend = createActor(canisterId);
