...
import { idlFactory } from './trackingcontract_frontend.did.js';
export { idlFactory } from './trackingcontract_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TRACKINGCONTRACT_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./trackingcontract_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the trackingcontract_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./trackingcontract_frontend.did.js")._SERVICE>}
 */
export const trackingcontract_frontend = createActor(canisterId);
